(* OASIS_START *)
(* DO NOT EDIT (digest: 12a6a94d2b2d1cd42baf76eb0454a072) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [
          ("dom_type.client", ["client/src"], []);
          ("dom_type.client.syntax", ["client/syntax"], []);
          ("dom_type.server", ["server/src"], []);
          ("dom_type.server.syntax", ["server/syntax"], [])
       ];
     lib_c = [];
     flags = [];
     includes = []
