...
(* OASIS_START *)
(* DO NOT EDIT (digest: 98b13ec60e18e49ceb0ef163ea3e3cd7) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("eliom.syntax.client", None);
               ...
               Library
                 ({
                     cs_name = "dom_type.client.syntax";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("js_of_ocaml-camlp4.deriving", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
               ...
               Library
                 ({
                     cs_name = "dom_type.server.syntax";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_digest = Some "\175\162:JDY\252*\tQP\209\139T4\166";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
